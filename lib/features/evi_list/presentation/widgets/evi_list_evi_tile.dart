      ...
      child: MouseRegion(
        ...
        child: AnimatedContainer(
          ...
          decoration: BoxDecoration(
            ...
            border: Border.all(
              color: _tint.withValues(alpha: _hovered ? 0.35 : 0.15),
              width: 1.0,
            ),
            gradient: LinearGradient(
              ...
              colors: [
                ...
                const Color(0xFFF4F6FA).withValues(alpha: 0.90),
              ],
            ),
            boxShadow: [
              BoxShadow(
                color: _tint.withValues(alpha: _hovered ? 0.18 : 0.06),
      ...
      return Padding(
        ...
        child: Container(
          ...
          decoration: BoxDecoration(
            ...
            color: const Color(0xFFE8EDF5).withValues(alpha: 0.4),
            border: Border.all(
              color: const Color(0xFFDDE5F0).withValues(alpha: 0.5),
            ),
          ),
          child: Text(
            'No partition files',
